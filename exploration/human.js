...
function createCubeBufferInfo(gl, size) {
  var s = size * 0.5;
  var positions = [];
  var colors = [];
  var faces = [
    // face normal-ish grouping: each face = 4 corners, 2 triangles
  ...
  var faceColors = [
    [0.6,0.2,0.2,1],[0.2,0.6,0.2,1],[0.2,0.2,0.6,1],
  ...
  faces.forEach(function(f, i) {
    ...
    idx.forEach(function(vi) {
      ...
      colors.push(c[0]*255, c[1]*255, c[2]*255, c[3]*255);
    });
  });
...
function main() {
  ...
  var cubeBufferInfo = createCubeBufferInfo(gl, 1);
  ...
  var blockGuyNodeDescriptions = {
    ...
    draw: false,
    children: [
      { name: "waist", translation: [0, 3, 0], children: [
        { name: "torso", translation: [0, 2, 0], children: [
          { name: "neck", translation: [0, 1, 0], children: [
            { name: "head", translation: [0, 1, 0] },
          ]},
          { name: "left-arm", translation: [-1, 0, 0], children: [
            { name: "left-forearm", translation: [-1, 0, 0], children: [
              { name: "left-hand", translation: [-1, 0, 0] },
            ]},
          ]},
          { name: "right-arm", translation: [1, 0, 0], children: [
            { name: "right-forearm", translation: [1, 0, 0], children: [
              { name: "right-hand", translation: [1, 0, 0] },
            ]},
          ]},
        ]},
        { name: "left-leg", translation: [-1, -1, 0], children: [
          { name: "left-calf", translation: [0, -1, 0], children: [
            { name: "left-foot", translation: [0, -1, 0] },
          ]},
        ]},
        { name: "right-leg", translation: [1, -1, 0], children: [
          { name: "right-calf", translation: [0, -1, 0], children: [
            { name: "right-foot", translation: [0, -1, 0] },
          ]},
        ]},
      ]},
    ],
